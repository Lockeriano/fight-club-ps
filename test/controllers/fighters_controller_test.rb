...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { description: @fighter.description, first_name: @fighter.first_name, last_name: @fighter.last_name } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { description: @fighter.description, first_name: @fighter.first_name, last_name: @fighter.last_name } }
